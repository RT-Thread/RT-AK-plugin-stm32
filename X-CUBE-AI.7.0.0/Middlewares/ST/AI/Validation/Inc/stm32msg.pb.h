...
/* Generated by nanopb-0.3.9.1 at Mon May 31 13:57:56 2021. */
...
#define _EnumAiRuntime_MAX EnumAiRuntime_AI_RT_TVM
#define _EnumAiRuntime_ARRAYSIZE ((EnumAiRuntime)(EnumAiRuntime_AI_RT_TVM+1))
...
#define _EnumTools_MAX EnumTools_AI_MDK_6
#define _EnumTools_ARRAYSIZE ((EnumTools)(EnumTools_AI_MDK_6+1))

typedef enum _EnumCapability {
    EnumCapability_CAP_INSPECTOR = 1,
    EnumCapability_CAP_FIXED_POINT = 2,
    EnumCapability_CAP_RELOC = 4,
...
typedef enum _EnumLayerType {
    ...
    EnumLayerType_LAYER_TYPE_INTERNAL_DATA_NO_LAST = 4
} EnumLayerType;
#define _EnumLayerType_MIN EnumLayerType_LAYER_TYPE_OUTPUT
#define _EnumLayerType_MAX EnumLayerType_LAYER_TYPE_INTERNAL_DATA_NO_LAST
#define _EnumLayerType_ARRAYSIZE ((EnumLayerType)(EnumLayerType_LAYER_TYPE_INTERNAL_DATA_NO_LAST+1))
...
extern const int32_t aiBufferShapeMsg_addr_default;

/* Initializer values for message structs */
#define reqMsg_init_default                      {0, EnumCmd_CMD_SYS_INFO, 0, "", 0}
#define aiRunReportMsg_init_default              {0, 0, 0, 0, 0}
#define aiBufferShapeMsg_init_default            {0u, 1u, 1u, 1u, 1u, 0, 0, 0}
...
#define aiBufferShapeMsg_init_zero               {0, 0, 0, 0, 0, 0, 0, 0}
...
#define aiBufferShapeMsg_addr_tag                8
...
extern const pb_field_t aiBufferShapeMsg_fields[9];
...
#define aiBufferShapeMsg_size                    57

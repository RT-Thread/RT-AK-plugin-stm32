...
#if !defined(STM32F7) && !defined(STM32L4) && !defined(STM32L5) && !defined(STM32F4) && !defined(STM32H7) && !defined(STM32F3) && !defined(STM32U5)
#error Only STM32H7, STM32F7, STM32F4, STM32L4, STM32L5, STM32U5 or STM32F3 device are supported
#endif
#endif
